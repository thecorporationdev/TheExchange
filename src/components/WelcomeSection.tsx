  ...
  return (
    <section className="relative py-15 px-6 md:px-12 lg:px-24 flex items-center justify-center overflow-hidden">
      <div className="w-full text-center">
        ...
        <h1 className="mt-[15px] ml-5 md:ml-0 md:mt-10 text-[21.5px] md:text-[36px] lg:text-[48px] font-medium text-gray-900 max-w-6xl text-left leading-[30px] md:leading-tight lg:leading-snug md:text-left mx-auto">
