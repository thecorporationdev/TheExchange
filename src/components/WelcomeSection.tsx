  ...
  return (
    <section className="relative bg-white py-24 px-6 md:px-12 lg:px-24 flex items-center justify-center min-h-[500px] overflow-hidden">
      <div className="w-full text-center">
        <p className="text-xs md:text-sm uppercase tracking-[0.3em] text-black font-bold mb-6 absolute top-6 left-6 md:left-12 lg:left-5 font-resotho">
          Welcome
        </p>
        ...
        <p className="text-xs md:text-sm uppercase font-bold tracking-[0.3em] text-black mt-6 absolute bottom-6 right-6 md:right-12 lg:right-5 font-resotho">
          Know More
        </p>
      </div>
    </section>
