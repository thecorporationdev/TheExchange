  ...
  return (
    <section className="relative py-15 px-6 md:px-12 lg:px-24 flex items-center justify-center overflow-hidden">
      <div className="w-full text-center">
        <p className="font-bold lg:text-[16px] text-[12px]  uppercase lg:tracking-[0.1em] tracking-[0.16em] text-black font-bold mb-6 absolute lg:top-15 top-10 left-6 md:left-12 lg:left-5 font-resotho">
          Welcome
        </p>
